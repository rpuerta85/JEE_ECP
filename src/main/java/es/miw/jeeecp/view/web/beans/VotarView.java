...
//        }
  return "";
	...
	private void inicializarListaEstudios(){
        ...
        listaNivelEstudios.add("Formaci�n Profesional Grado Medio");
        listaNivelEstudios.add("Bachillerato");
        listaNivelEstudios.add("Formaci�n Profesional Grado Superior");
        listaNivelEstudios.add("Ingenier�a t�cnica");
